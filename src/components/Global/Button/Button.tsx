...
import { applyStyleToMultipleVariants, classNames } from "../CVA";
  ...
  "inline-flex items-center text-sm font-medium relative rounded-md transition-colors",
  {
    ...
    compoundVariants: [
      // Primary variants
      {
        ...
        color: "primary",
        className:
          "bg-gray-800 bg-opacity-30 dark:bg-opacity-30 dark:bg-darkgray-800",
      },
      {
        loading: true,
        color: "primary",
        className:
          "bg-gray-800/30 text-white/30 dark:bg-opacity-30 dark:bg-darkgray-700 dark:text-black/30",
      },
